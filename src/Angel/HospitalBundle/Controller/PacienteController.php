...
class PacienteController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('paciente_show', array('id' => $paciente->getIdpaciente()));
        }
    ...
    public function editAction(Request $request, Paciente $paciente)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('paciente_edit', array('id' => $paciente->getIdpaciente()));
        }
    ...
    private function createDeleteForm(Paciente $paciente)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('paciente_delete', array('id' => $paciente->getIdpaciente())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
